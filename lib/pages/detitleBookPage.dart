import 'package:crud_book/models/bookModel.dart';
import 'package:crud_book/pages/editBookPage.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Center(
              child: Image.asset('assets/stackBooksEducation.png', height: 200,)
              // Image.network(
